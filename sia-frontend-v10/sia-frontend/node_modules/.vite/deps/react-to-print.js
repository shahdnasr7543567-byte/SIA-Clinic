    ...
    if (e.contentWindow) {
      ...
      if (e.contentWindow.focus(), h)
        ...
        if (e.contentWindow.print) {
          const c = ((_a = e.contentDocument) == null ? void 0 : _a.title) ?? "", E = e.ownerDocument.title, y = typeof n == "function" ? n() : n;
...
function W(e, t, n) {
  ...
  e.onload = null;
  const d = e.contentDocument ?? ((_a = e.contentWindow) == null ? void 0 : _a.document);
  if (d) {
    const k = d.body.appendChild(p);
    F && j(l, k, !!A), E && (((_b = e.contentDocument) == null ? void 0 : _b.fonts) && ((_c = e.contentWindow) == null ? void 0 : _c.FontFace) ? E.forEach((s) => {
...
function Z({
  ...
  return (0, import_react.useCallback)((L) => {
    $(y, true);
    function _() {
      const i = {
        bodyClass: e,
    ...
    a ? a().then(() => {
      ...
      c == null ? void 0 : c("onBeforePrint", P(i));
    }) : _();
  }, [
    e,
    t,
