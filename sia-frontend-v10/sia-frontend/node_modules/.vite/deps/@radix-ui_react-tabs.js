...
var RovingFocusGroup = React3.forwardRef(
  ...
  __name2(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React3.forwardRef(__name2(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React3.forwardRef(
  // blank line to reduce diff noise
  __name2(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
var Tabs = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function Tabs2(props, forwardedRef) {
    const {
      __scopeTabs,
      value: valueProp,
      onValueChange,
...
var TabsList = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function TabsList2(props, forwardedRef) {
...
var TabsTrigger = React4.forwardRef(
  __name3(function TabsTrigger2(props, forwardedRef) {
...
var TabsContent = React4.forwardRef(
  __name3(function TabsContent2(props, forwardedRef) {
...
__name3(makeTriggerId, "makeTriggerId");
function makeContentId(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name3(makeContentId, "makeContentId");
var Root2 = Tabs;
var List = TabsList;
