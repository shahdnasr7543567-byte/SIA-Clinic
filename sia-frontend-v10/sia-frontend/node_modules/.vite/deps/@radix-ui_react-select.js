...
import {
  ...
  useDirection,
  useId
} from "./chunk-XHQDBGYZ.js";
import {
  createContextScope,
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-H6IBDAEQ.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-CR6TKEPA.js";
import {
  require_react_dom
...
var DismissableLayer = React.forwardRef(
  ...
  __name2(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    React.useEffect(() => {
      const handleUpdate = __name2(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React.forwardRef(__name2(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React.useContext(DismissableLayerContext);
...
__name2(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = __name2(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React.useEffect(() => {
    ...
    __name2(resetOutsideInteraction, "resetOutsideInteraction");
    function isOutsideInteractionIntercepted() {
      return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
    }
    __name2(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
    ...
    __name2(handleInteractionCapture, "handleInteractionCapture");
    function handleInteractionBubble(event) {
      if (isPointerDownOutsideRef.current) {
        interceptedOutsideInteractionEventsRef.current.set(event.type, false);
      }
    }
    __name2(handleInteractionBubble, "handleInteractionBubble");
    const handlePointerDown = __name2((event) => {
      if (event.target && !isPointerInsideReactTreeRef.current) {
        ...
        __name2(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
  ...
  return {
    ...
    onPointerDownCapture: __name2(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  ...
  React.useEffect(() => {
    const handleFocus = __name2((event) => {
  ...
  return {
    onFocusCapture: __name2(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name2(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
...
__name3(FocusGuards, "FocusGuards");
...
__name3(useFocusGuards, "useFocusGuards");
...
__name3(createFocusGuard, "createFocusGuard");
...
var FocusScope = React3.forwardRef(
  __name4(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
    ...
    React3.useEffect(() => {
      if (trapped) {
        ...
        __name4(handleFocusIn2, "handleFocusIn");
        __name4(handleFocusOut2, "handleFocusOut");
        __name4(handleMutations2, "handleMutations");
...
__name4(getTabbableEdges, "getTabbableEdges");
function getTabbableCandidates(container) {
  const nodes = [];
  const walker = document.createTreeWalker(container, NodeFilter.SHOW_ELEMENT, {
    acceptNode: __name4((node) => {
...
__name4(getTabbableCandidates, "getTabbableCandidates");
...
__name4(findVisible, "findVisible");
...
__name4(isHidden, "isHidden");
function isSelectableInput(element) {
  return element instanceof HTMLInputElement && "select" in element;
}
__name4(isSelectableInput, "isSelectableInput");
...
__name4(createFocusScopesStack, "createFocusScopesStack");
...
__name4(arrayRemove, "arrayRemove");
function removeLinks(items) {
  return items.filter((item) => item.tagName !== "A");
}
__name4(removeLinks, "removeLinks");
...
var Arrow = React5.forwardRef(
  __name5(function Arrow2(props, forwardedRef) {
...
var Popper = __name7((props) => {
  const { __scopePopper, children } = props;
  const [anchor, setAnchor] = React7.useState(null);
  const [placementState, setPlacementState] = React7.useState(void 0);
...
var PopperAnchor = React7.forwardRef(
  __name7(function PopperAnchor2(props, forwardedRef) {
    const { __scopePopper, virtualRef, ...anchorProps } = props;
    const context = usePopperContext(ANCHOR_NAME, __scopePopper);
    const ref = React7.useRef(null);
    const onAnchorChange = context.onAnchorChange;
    const callbackRef = React7.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
    ...
    return virtualRef ? null : (0, import_jsx_runtime4.jsx)(
      Primitive.div,
      {
...
var PopperContent = React7.forwardRef(
  __name7(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name7((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name7(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React7.forwardRef(
  __name7(function PopperArrow2(props, forwardedRef) {
...
__name7(isNotNull, "isNotNull");
var transformOrigin = __name7((options) => ({
...
__name7(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root2 = Popper;
...
__name9(usePrevious, "usePrevious");
...
function SelectProvider(props) {
  ...
  const initialValueRef = React20.useRef(value);
  React20.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name11(() => setValue(initialValueRef.current), "reset");
  ...
  const handleNativeOptionAdd = React20.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React20.useCallback((option) => {
  ...
  return (0, import_jsx_runtime7.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime7.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime7.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime7.jsx)(
...
__name11(SelectProvider, "SelectProvider");
var Select = __name11((props) => {
  ...
  return (0, import_jsx_runtime7.jsx)(
    SelectProvider,
    {
      __scopeSelect,
      ...providerProps,
      internal_do_not_use_render: ({ isFormControl }) => (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
        children,
...
var SelectTrigger = React20.forwardRef(
  __name11(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name11((pointerEvent) => {
      if (!isDisabled) {
...
var SelectValue = React20.forwardRef(
  __name11(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime7.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime7.jsx)(React20.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React20.forwardRef(
  __name11(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name11((props) => {
  const { __scopeSelect, forceMount, ...portalProps } = props;
  return (0, import_jsx_runtime7.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime7.jsx)(Portal, { asChild: true, ...portalProps }) });
}, "SelectPortal");
var CONTENT_NAME2 = "SelectContent";
var SelectContent = React20.forwardRef(
  __name11(function SelectContent2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime7.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime7.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime7.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }, "SelectContent")
);
var SelectContentFragment = React20.forwardRef(__name11(function SelectContentFragment2(props, forwardedRef) {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM3.createPortal(
    (0, import_jsx_runtime7.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime7.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime7.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
...
var SelectContentImpl = React20.forwardRef(
  // blank line to reduce diff noise
  __name11(function SelectContentImpl2(props, forwardedRef) {
    ...
    React20.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name11((event) => {
          var _a, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name11((event) => {
    ...
    React20.useEffect(() => {
      const close = __name11(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React20.forwardRef(__name11(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React20.forwardRef(__name11(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React20.forwardRef(
  __name11(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React20.forwardRef(
  __name11(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React20.forwardRef(
  __name11(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React20.forwardRef(
  __name11(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React20.forwardRef(
  __name11(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React20.forwardRef(
  // blank line to reduce diff noise
  __name11(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React20.forwardRef(__name11(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name11(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React20.forwardRef(__name11(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React20.forwardRef(__name11(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React20.forwardRef(
  // blank line to reduce diff noise
  __name11(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React20.forwardRef(
  __name11(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME2, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime7.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME = "SelectBubbleInput";
var SelectBubbleInput = React20.forwardRef(
  // blank line to reduce diff noise
  __name11(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
    ...
    return (0, import_jsx_runtime7.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime7.jsx)("option", { value: "" }) : null,
...
__name11(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React20.useCallback(
    (key) => {
      ...
      __name11(function updateSearch(value) {
...
__name11(useTypeaheadSearch, "useTypeaheadSearch");
...
__name11(findNextItem, "findNextItem");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name11(wrapArray, "wrapArray");
export {
